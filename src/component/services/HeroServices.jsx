...
const HeroServices = () => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[100vh] flex items-center justify-center px-4 md:px-12 py-24 bg-gradient-to-r from-blue-100 to-purple-100">
      {/* 🔹 Background Blobs */}
      <div className="absolute top-[-100px] left-[-100px] w-[500px] h-[500px] bg-blue-400/20 blur-[200px] rounded-full animate-pulse-slow"></div>
      <div className="absolute bottom-[-80px] right-[-80px] w-[450px] h-[450px] bg-purple-600/10 blur-[180px] rounded-full animate-pulse-slow"></div>
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            Premium <span className="text-teal-400">Mobile Services & Repairs</span>
          </h1>

          <p
            data-aos="fade-up"
            data-aos-delay="200"
            className="mt-6 text-lg md:text-xl leading-relaxed max-w-xl text-gray-200"
          >
            High-quality accessories and professional repair services to keep your devices in top shape.
          </p>
          ...
          <ul
            data-aos="fade-up"
            data-aos-delay="400"
            className="flex mt-8 gap-4 justify-center lg:justify-start text-white"
          >
            <li className="inline-flex items-center gap-2 px-4 py-2 bg-[#002B5B] rounded-full shadow-lg text-sm">
              <FaCheck className="text-white" /> 1 Year Warranty
            </li>
            <li className="inline-flex items-center gap-2 px-4 py-2 bg-[#002B5B] rounded-full shadow-lg text-sm">
              <FaCheck className="text-white" /> Quick Service
            </li>
            <li className="inline-flex items-center gap-2 px-4 py-2 bg-[#002B5B] rounded-full shadow-lg text-sm">
              <FaCheck className="text-white" /> Genuine Parts
            </li>
          </ul>
        ...
        <div className="relative w-full max-w-2xl group">
          <img
            src="public/eh5.png" // Replace with your own image URL
